...
namespace FlowerInventory.Services
{
    public class ProductsService : IProductsService
    {
        ...
        public List<ProductModel> newList = new List<ProductModel>();
        public List<ProductModel> mockList = new List<ProductModel>();
        ...
        public IEnumerable<ProductModel> CreateList()
        {
            if (mockList.Count == 0)
            {
